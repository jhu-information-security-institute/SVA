...
1. `# su kali`
1. `$ cd /home/kali`
1. Download Eclipse CDT (C/C++ IDE) for 64-bit Linux in your container using - `$ wget [https://download.eclipse.org/technology/epp/downloads/release/2022-09/R/eclipse-cpp-2022-09-R-linux-gtk-x86_64.tar.gz](https://download.eclipse.org/technology/epp/downloads/release/2022-12/M2/eclipse-cpp-2022-12-M2-linux-gtk-x86_64.tar.gz)`
